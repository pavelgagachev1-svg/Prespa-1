export const blogPosts = [
  {
    ...
    content: `Twenty-five young people from the Prespa region gathered in Resen for a three-day workshop focused on sustainable agriculture and environmental protection. [cite: 1, 2] Organized by local volunteers and educators, the event introduced participants to modern farming methods, eco-friendly practices, and business opportunities connected to agriculture. [cite: 3]
...
Through training sessions and field visits, participants learned about organic farming, smart irrigation, and local product marketing. [cite: 4] Many young attendees said the workshop changed their perspective on farming and inspired them to stay involved in their community. [cite: 5] Organizers hope the initiative will encourage more young people to help build a sustainable future for Resen and the Prespa region. [cite: 6]`
  },
  {
    ...
    content: `Recent environmental measurements around Lake Prespa show encouraging signs of improved water quality following months of conservation efforts. [cite: 7, 8] Experts reported reduced pollution levels and healthier conditions in several monitored areas. [cite: 9]
